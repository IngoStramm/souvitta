...
- Souvitta (Nome do plugin)
- souvitta (nome dos arquivos, nome do text domain e slug da url do repositório)
- SVT_ (prefixo usado nas constantes de Url e diretório do plugin, além das classes)
- gpx_ (prefixo usado nas funções)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do Souvitta, através do próprio sistema de atualizações do WordPress
