...
class SVT_Post_Type
{
    ...
    protected function labels()
    {
        $default = array(
            ...
            'add_new'            => __('Add New', 'souvitta'),
            'add_new_item'       => sprintf(__('Add New %s', 'souvitta'), $this->name),
            'new_item'           => sprintf(__('New %s', 'souvitta'), $this->name),
            'all_items'          => sprintf(__('All %ss', 'souvitta'), $this->name),
            'not_found'          => sprintf(__('No %s found', 'souvitta'), $this->name),
            'not_found_in_trash' => sprintf(__('No %s found in Trash', 'souvitta'), $this->name)
        );
